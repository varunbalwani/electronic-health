...
app.listen(3000, () => console.log('Backend server running on 3000'));
...
// //////////////////////////////// Doctor Routes //////////////////////////////////////
app.patch('/patients/:patientId/details/medical', authenticateJWT,upload.single('prescription') , doctorRoutes.updatePatientMedicalDetails);
